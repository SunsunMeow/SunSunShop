...
{
    public partial class SunSunDbContext : DbContext
    {
        public SunSunDbContext()
            : base("name=SunSunDbContext")
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AttributesPrice>()
                ...
                .WithOptional(e => e.AttributesPrice)
            ...
            modelBuilder.Entity<TransactStatu>()
                .HasMany(e => e.Orders)
                .WithOptional(e => e.TransactStatu)
